...
function AddTrailer(){
    ...
    const [dismount, setDismount] = useState(false) //is a trailer dismountable
    const address = "";
        ...
        <div className="site-first-div" style={{marginLeft}}>
            ...
            <div className='addtrailer-locate'>
                <form onSubmit={handleSubmit} className='deactivateaccount-form'>
                    ...
                    <div>
                        <label className='addtrailer-odczep' for='odczep'>Czy naczepa jest odczepialna?</label>
                        <input id='odczep' className='deactivateaccount-password' type='checkbox' required onChange={e => setDismount(e.target.value)}></input>
                    </div>
